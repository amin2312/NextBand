...
1. 健康与养老关怀
   - 当检测到心率或血氧异常时，自动通知家人。
   - 当满足预设的健康条件时，自动联系指定的紧急联系人。
2. 运动与健身
   - “如果我的心率超过 160 BPM，提醒我降低运动强度。”
   - 根据心率、活动水平和运动状态动态调整训练计划。
3. 睡眠与日常健康管理
   - “如果连续几个晚上睡眠期间心率异常偏高，提醒我预约体检。”
   - 分析心率、血氧等生物特征数据，为用户健康提供更深入的洞察。
4. 独立生活与人身安全
   - “如果我长时间没有活动且心率异常，请联系我的家人。”
   - 结合跌倒检测、GPS 等能力，自动触发安全警报和紧急救助。
5. 压力与情绪健康
   - “如果我的心率持续偏高，提醒我休息一下。”
   - 结合健康指标的变化，识别潜在的压力或疲劳。
6. 个人 AI 助手
   - 超越健康监测，将可穿戴设备打造为 AI Agent 的入口。
   - 未来可连接智能家居设备、企业系统等服务，实现真正的 感知 → 思考 → 行动 体验。
